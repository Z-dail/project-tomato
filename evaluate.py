# miniconda3/envs/tomato# conda install seaborn scikit-learn(1.1.3)  keras
# conda install opencv=4.6.0 -c conda-forge
# OpenCV 4.5.5、4.6.0、4.7.0 等版本都支持 Python 3.8
...
if __name__ == "__main__":
    ...
    _, _, test_generator = load_dataset(config)
